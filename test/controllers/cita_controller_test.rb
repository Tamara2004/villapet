...
class CitaControllerTest < ActionController::TestCase
  ...
  test "should create citum" do
    assert_difference('Citum.count') do
      post :create, citum: { control: @citum.control, fecha: @citum.fecha, obsevacion: @citum.obsevacion, recepcion_id: @citum.recepcion_id }
    end
  ...
  test "should update citum" do
    patch :update, id: @citum, citum: { control: @citum.control, fecha: @citum.fecha, obsevacion: @citum.obsevacion, recepcion_id: @citum.recepcion_id }
    assert_redirected_to citum_path(assigns(:citum))
  end
